  ...
  return (
    <div className="space-y-6" data-testid="screener-page">
      ...
      <div className="grid lg:grid-cols-5 gap-4">
        ...
        {filtersOpen && (
          <Card className="glass-card lg:col-span-1 max-h-[calc(100vh-200px)] overflow-y-auto max-w-[220px]" data-testid="filters-panel">
        ...
        <Card className={`glass-card ${filtersOpen ? 'lg:col-span-4' : 'lg:col-span-5'}`} data-testid="results-table">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              {activeScan && (
                <Badge className="ml-1 bg-violet-500/20 text-violet-400 border-violet-500/30 text-xs">
                  Pre-Computed
                </Badge>
              )}
            </CardTitle>
